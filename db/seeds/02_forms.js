...
exports.seed = function(knex) {
  return knex('forms').del()
    .then(function () {
      ...
      knex('messengers').del().then(function () {
        return knex('messengers').insert([
      ...
      knex('forms_messengers').del().then(function () {
        return knex('forms_messengers').insert([
      ...
      knex('languageSkills').del().then(function () {
        return knex('languageSkills').insert([
      ...
      knex('forms_languageSkills').del().then(function () {
        return knex('forms_languageSkills').insert([
      ...
      knex('forms_professions').del().then(function () {
        return knex('forms_professions').insert([
