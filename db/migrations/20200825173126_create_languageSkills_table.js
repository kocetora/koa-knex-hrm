...
exports.up = function(knex) {
  return knex.schema
  .createTable('languageSkills', function(table) {
...
exports.down = function(knex) {
  return knex.schema.dropTable('forms_languageSkills').dropTable('languageSkills').raw("DROP TYPE language, language_proficiency");
};
